/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 75e7922784db59272851d9342188326a)
// Runtime types generated with workerd@1.20260918.1 2026-03-01 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	TURNSTILE_SECRET_KEY: string;
	TURNSTILE_SITE_KEY: string;
	CONTACT_SYNTHETIC_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SECRET_KEY" | "TURNSTILE_SITE_KEY" | "CONTACT_SYNTHETIC_TOKEN">> {}
}
