export const consultationData = {
  ...
  qualityGuarantee: {
    ...
    paragraph: 'Every engagement is backed by our commitment to excellence. If the delivered solution doesn\'t meet the agreed specifications or your satisfaction, we\'ll work to resolve any issues at no additional cost. Your success is our primary objective.',
  },
  scheduling: {
